import { blogData, createBlog } from "./blog.js";
...
searchInput.addEventListener('input', () => {
    ...
    const searchBlog = blogData.filter(blog => {
        return (blog.content.toLocaleLowerCase().includes(searchData) || blog.description.toLocaleLowerCase().includes(searchData) || blog.title.toLocaleLowerCase().includes(searchData));
    });
